...
fn main() {
    ...
    let earth = CelestialBody
        ...
        .set_ephemeris(Ephemeris::from_spice("Earth").to_frame(Frame::J2000))
        .set_atmosphere(Atmosphere::from_nrlmsise00())
        .set_shape(Shape::sphere::new(6700e3))
        .set_rotation(Rotation::from_spice("Earth"))
        .set_magnetosphere(Magnetosphere::from_yaml("emm99.txt"))
        .set_eom(Propagation::cowel())
        .set_parent(sun)
        .validate();
